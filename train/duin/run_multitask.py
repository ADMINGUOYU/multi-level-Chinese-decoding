#!/usr/bin/env python3
"""
Multi-task training script for Du-IN model.
Combines semantic, visual, and acoustic alignment tasks with shared encoder.

Created for multi-task learning implementation
@author: Claude Code
"""
...
from models.duin import duin_multitask as duin_model
