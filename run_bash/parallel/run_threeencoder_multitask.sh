...
echo "========================================="
echo "All subjects three-encoder multi-task training completed!"
echo "========================================="